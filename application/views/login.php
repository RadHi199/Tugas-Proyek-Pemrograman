...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login Wistara Autoparts</title>
      ...
      <div class="main-content">
        <div class="row">
          <div class="col-sm-10 col-sm-offset-1">
            ...
            <div class="center">
                <h1>
                  <span class="purple">WISTARA</span>
                  <span class="white" id="id-text2">AUTOPARTS</span>
                </h1>
                <h4 class="header blue lighter bigger" id="id-company-text">&copy; 2020</h4>
              </div>
            <br>
